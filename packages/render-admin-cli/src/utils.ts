...
import {
  ...
  sendInstructions,
  toBN,
} from "@render-foundation/spl-utils";
import {
          ...
          const addAddressesInstruction =
            await AddressLookupTableProgram.extendLookupTable({
              ...
              addresses: addTxIxns[0].keys
                .map((k: any) => k.pubkey)
                .filter((p: any) => !walletSigner!.publicKey.equals(p)),
            });
